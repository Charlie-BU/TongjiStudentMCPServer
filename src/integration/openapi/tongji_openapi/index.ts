...
import type {
  ...
  User_data_statisticsQueryRequest,
  User_data_statisticsHeaderRequest,
  ...
  Lend_info_allQueryRequest,
  Lend_info_allHeaderRequest,
  Library_current_borrowQueryRequest,
  Library_current_borrowHeaderRequest,
  Lib_access_controlQueryRequest,
  Lib_access_controlHeaderRequest,
  ...
  School_calendar_all_term_calendarHeaderRequest,
  School_calendar_current_term_calendarHeaderRequest,
  ...
  Competition_winnersQueryRequest,
  Competition_winnersHeaderRequest,
  StipendQueryRequest,
  StipendHeaderRequest,
  Class_infoQueryRequest,
  Class_infoHeaderRequest,
  Work_studyQueryRequest,
  Work_studyHeaderRequest,
  Honorary_titleQueryRequest,
  Honorary_titleHeaderRequest,
  ...
  User_annual_billQueryRequest,
  User_annual_billHeaderRequest,
} from './namespaces';
...
export default class Tongji_openapiService<T> {
  ...
  User_data_statisticsGET(
    req: User_data_statisticsQueryRequest & User_data_statisticsHeaderRequest,
    options?: T,
  ): Promise<any> {
    const _req = req || {};
  ...
  /** 图书借阅信息 */
  Lend_info_allGET(
    req: Lend_info_allQueryRequest & Lend_info_allHeaderRequest,
    options?: T,
  ): Promise<any> {
    const _req = req || {};
  ...
  Lib_access_controlGET(
    req: Lib_access_controlQueryRequest & Lib_access_controlHeaderRequest,
    options?: T,
  ): Promise<any> {
    const _req = req || {};
  ...
  School_calendar_all_term_calendarGET(
    req: School_calendar_all_term_calendarHeaderRequest,
    options?: T,
  ): Promise<any> {
    const _req = req || {};
    let url = this.genBaseURL(
  ...
  School_calendar_current_term_calendarGET(
    req: School_calendar_current_term_calendarHeaderRequest,
    options?: T,
  ): Promise<any> {
    const _req = req || {};
    let url = this.genBaseURL(
  ...
  /** 根据学号查询竞赛获奖情况信息 */
  Competition_winnersGET(
    req: Competition_winnersQueryRequest & Competition_winnersHeaderRequest,
    options?: T,
  ): Promise<any> {
    const _req = req || {};
  ...
  /** 根据学号查询学生获得助学金情况信息 */
  StipendGET(
    req: StipendQueryRequest & StipendHeaderRequest,
    options?: T,
  ): Promise<any> {
    const _req = req || {};
  ...
  /** 根据学号查询学生获得荣誉称号情况信息 */
  Honorary_titleGET(
    req: Honorary_titleQueryRequest & Honorary_titleHeaderRequest,
    options?: T,
  ): Promise<any> {
    const _req = req || {};
  ...
  /** 根据学号查询学生获得奖学金情况信息 */
  ScholarshipGET(
    req: ScholarshipQueryRequest & ScholarshipHeaderRequest,
    options?: T,
  ): Promise<any> {
    const _req = req || {};
  ...
  /** 获取教务系统所有的学生基本信息 */
  All_studentGET(
    req: All_studentQueryRequest & All_studentHeaderRequest,
    options?: T,
  ): Promise<any> {
    const _req = req || {};
  ...
  /** 根据学号和年份查询全校师生统计数据 */
  User_annual_billGET(
    req: User_annual_billQueryRequest & User_annual_billHeaderRequest,
    options?: T,
  ): Promise<any> {
    const _req = req || {};
    ...
    const method = 'GET';
    const data = undefined;
    const params = { userId: _req['userId'], year: _req['year'] };
    const headers = { Authorization: _req['Authorization'] };
    return this.request({ url, method, data, params, headers }, options);
  }
}
