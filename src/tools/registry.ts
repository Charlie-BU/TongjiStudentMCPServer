...
import { registerCardSpendingFlowTool } from "./tongji/user/card_spending_flow";
import { registerCompetitionPrizeTool } from "./tongji/bachelor/competition_prize";
import { registerHonoraryTitleTool } from "./tongji/student/honorary_title";
import { registerLibraryAccessTool } from "./tongji/user/library_access";
import { registerSchoolAccessTool } from "./tongji/user/school_access";
...
import { registerUndergraduateScoreTool } from "./tongji/bachelor/score";
import { registerAllTermCalendarTool } from "./tongji/user/term-calendar";
import { registerCurrentTermCalendarTool } from "./tongji/user/current-term-calendar";
import { registerCetScoreTool } from "./tongji/student/cet-score";
import { registerBookLendInfoTool } from "./tongji/user/book-lend-info";
import { registerStatisticsInfoTool } from "./tongji/user/statistics-info";
...
import { registerResearchProjectsTool } from "./tongji/user/research_projects";
import { registerResearchWorksTool } from "./tongji/user/research_works";
...
import { registerCardBalanceTool } from "./tongji/user/card_balance";
...
import { registerResearchPatentsTool } from "./tongji/user/research_patents";
...
import { registerStudentGradeSummaryTool } from "./tongji/bachelor/grade_summary";
