...
// ANNUAL_BILL_TOOL_NAME 表示用户年度统计账单查询工具名称。
export const ANNUAL_BILL_TOOL_NAME = "tongji.user.annual_bill";
// registerAnnualBillTool 注册用户年度统计账单查询工具。
export const registerAnnualBillTool = campusTool({
    audience: "user",
    name: ANNUAL_BILL_TOOL_NAME,
    title: "查询用户年度统计账单",
    description: "查询当前已授权用户指定年份的校园年度统计账单。",
    input: z.object({
        year: z
...
// normalizeAnnualBillData 裁剪并规范化用户年度统计账单业务数据。
...
// normalizeAnnualBill 裁剪并规范化单条用户年度统计账单。
