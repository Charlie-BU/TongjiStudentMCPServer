...
import { getAllTermCalendars, getBookLendInfo, getCetScores, getCurrentTermCalendar, getStatisticsInfo, getUndergraduateScores } from '../../src/integration/tongji_openapi';
