...
import { ANNUAL_BILL_TOOL_NAME } from "../src/tools/tongji/user/annual_bill";
import { CARD_SPENDING_FLOW_TOOL_NAME } from "../src/tools/tongji/user/card_spending_flow";
import { COMPETITION_PRIZE_TOOL_NAME } from "../src/tools/tongji/bachelor/competition_prize";
import { COURSE_CATALOG_TOOL_NAME } from "../src/tools/tongji/course/search";
import { HONORARY_TITLE_TOOL_NAME } from "../src/tools/tongji/student/honorary_title";
import { LIBRARY_ACCESS_TOOL_NAME } from "../src/tools/tongji/user/library_access";
import { SCHOOL_ACCESS_TOOL_NAME } from "../src/tools/tongji/user/school_access";
import { SCHOLARSHIP_INFO_TOOL_NAME } from "../src/tools/tongji/student/scholarship_info";
import { STUDENT_DETAILED_INFO_TOOL_NAME } from "../src/tools/tongji/student/detailed_info";
import { STUDENT_TIMETABLE_TOOL_NAME } from "../src/tools/tongji/student/timetable";
import { UNDERGRADUATE_SCORE_TOOL_NAME } from "../src/tools/tongji/bachelor/score";
import { TERM_CALENDAR_TOOL_NAME } from "../src/tools/tongji/user/term-calendar";
import { CURRENT_TERM_CALENDAR_TOOL_NAME } from "../src/tools/tongji/user/current-term-calendar";
import { CET_SCORE_TOOL_NAME } from "../src/tools/tongji/student/cet-score";
import { BOOK_LEND_INFO_TOOL_NAME } from "../src/tools/tongji/user/book-lend-info";
import { STATISTICS_INFO_TOOL_NAME } from "../src/tools/tongji/user/statistics-info";
import { STIPEND_INFO_TOOL_NAME } from "../src/tools/tongji/student/stipend-info";
